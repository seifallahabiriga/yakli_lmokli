  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-7xl font-display font-semibold text-foreground">Off-grid</h1>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover internships, scholarships, research projects, and postdoc positions in AI and Data Science." },
    ],
    links: [
